   ...
   <!--文章管理-->
    ...
    <div class="home_li" >
      <div class="home_img"><i class="layui-icon" style="font-size:72px; color: #1E9FFF;">&#xe609;</i> </div>
       <div class="home_title">文档管理</div>
       <div class="home_con">添加/修改/更新/文档栏目</div>
    </div>
    </a>
    ...
    <div class="home_li" >
      <div class="home_img"><i class="layui-icon" style="font-size:72px; color: #1E9FFF;">&#xe62a;</i> </div>
       <div class="home_title">文档内容</div>
       <div class="home_con">添加/修改/更新/文档内容</div>
    </div>
    </a>
    ...
    <a href = "<?php echo site_url('Admin/pass'); ?>" >
     <div class="home_li" >
      <div class="home_img"><i class="layui-icon" style="font-size:72px; color: #1E9FFF;">&#xe612;</i> </div>
       ...
       <div class="home_con">修改/更新/用户信息</div>
    </div>
    </a>
    <!--后台主页功能模块结束-->
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>备注：</td>
            <td><a href="https://www.huxinchun.com">作者支持</a></td>
          </tr>
        </tbody>
      </table>
    </div>
